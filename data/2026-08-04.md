...
### [16] [MBO Scheme for Local Chan--Vese Segmentation](https://arxiv.org/abs/2608.00893)
...
### [17] [From Pixels to PCells: A Neurosymbolic Approach to Photonic Component Creation](https://arxiv.org/abs/2608.00084)
...
### [18] [Swimm3R: Splatting with Medium-aware SfM for Underwater 3D Reconstruction](https://arxiv.org/abs/2608.00950)
...
### [22] [Fermat Active Laplace Learning for Semi-Supervised Hyperspectral Image Classification](https://arxiv.org/abs/2608.02483)
...
### [23] [Logographic Character Visual Pretraining via Semantic-based Contrastive Learning](https://arxiv.org/abs/2608.00096)
...
### [37] [Interpretability-Guided Soft Pruning of Attention Heads in Vision Transformers](https://arxiv.org/abs/2608.00264)
...
### [67] [Cost-Effective Automated Judging of Natural-Language Mathematical Proofs](https://arxiv.org/abs/2608.00004)
*Benjamin Grayzel*
...
### [68] [RubricReviewer: From Direct Critique to Objective and Comprehensive Rubric-Driven Peer Review](https://arxiv.org/abs/2608.00005)
...
### [69] [MemoryForge: Synthesize Lifelong Memory for Human-Like LLM Agents](https://arxiv.org/abs/2608.00007)
...
### [70] [AgentMemBench: A Systematic Benchmark for Evaluating Long-Term Memory Management Strategies in Conversational AI Agents](https://arxiv.org/abs/2608.00009)
*Ahmed Cherif*
...
### [71] [DLLM-TTS: Block Discrete Diffusion Language Model for Text-to-Speech Synthesis](https://arxiv.org/abs/2608.00011)
...
### [72] [Obshazard-bench: Benchmarking Multimodal Foundation Models for Real-Time Disaster Intelligence from Raw Earth Observation Streams](https://arxiv.org/abs/2608.00012)
...
### [73] [What Transfers from Text to Vision? Capability Scaling Laws and Transfer Dynamics for VLMs](https://arxiv.org/abs/2608.00013)
...
### [74] [Role Steering of Language Models for Social Simulations](https://arxiv.org/abs/2608.00023)
...
### [75] [Exploring More to Solve More: Boosting Diversity in Text Diffusion Models via Entropy-Based Guidance](https://arxiv.org/abs/2608.00024)
...
### [76] [SLMs as Multi-Agent Routers: A Progressive SFT and Reinforcement Learning Approach](https://arxiv.org/abs/2608.00030)
...
### [77] [XL-DocBench: Benchmarking Evidence-Grounded Extra-Long Document Understanding](https://arxiv.org/abs/2608.00036)
...
### [78] [Trustworthiness Costs of Domain Adaptation in Small Language Models:A Cross-Architecture Empirical Study](https://arxiv.org/abs/2608.00042)
...
### [79] [Predicting Startup Exit from Textual Descriptors - A Computational Linguistics Framework](https://arxiv.org/abs/2608.00045)
...
### [80] [Neural Circuit Function Inference with LLMs](https://arxiv.org/abs/2608.00059)
...
### [81] [LLM-OSDA: An Optimal-Stopping Dynamic Auction for Native Advertising in Multi-Turn LLM Conversations](https://arxiv.org/abs/2608.00123)
...
### [82] [DiffusionGemma Technical Report](https://arxiv.org/abs/2608.00146)
...
### [83] [A Constitution-Grid Instrument for Data-Efficient RL Alignment (C-Guard)](https://arxiv.org/abs/2608.00180)
*Lily Zhang*
...
### [84] [Averaging Bias: Human Faithfulness Annotations are not Locally Faithful](https://arxiv.org/abs/2608.00205)
...
### [85] [Bridging the English-Arabic Medical Knowledge Gap: Targeted Low-Rank Adaptation via Causal Layer Selection](https://arxiv.org/abs/2608.00207)
...
### [86] [A Few Neurons Reveal When LLMs Misuse Tools: Sparse Detection and Selective Steering for Reliable Tool Use](https://arxiv.org/abs/2608.00218)
...
### [87] [Cross-Task Dissociation in Frontier Vision-Language Model Theory of Mind](https://arxiv.org/abs/2608.00261)
...
### [88] [Sixteen models, fewer than two voices: measuring ensemble dispersion where no answer is uniquely correct](https://arxiv.org/abs/2608.00285)
...
### [89] [Comparing and Modeling Argumentation in German Political Communication across Arenas](https://arxiv.org/abs/2608.00288)
...
### [90] [SeDeM: Selective Decompression of Hidden-State Memories for Long-Context Question Answering](https://arxiv.org/abs/2608.00311)
...
### [91] [CurveShift: Is Agent Progress Scalar? Separating Level from Shape](https://arxiv.org/abs/2608.00355)
...
### [92] [Deep Research Pretraining via Predictive Navigation](https://arxiv.org/abs/2608.00432)
...
### [93] [AdaMTP: An Adaptive Training Paradigm for Multi-Token Prediction](https://arxiv.org/abs/2608.00434)
...
### [94] [SERL-SQL: Selective Hindsight Distillation for Text-to-SQL Reinforcement Agentic Learning](https://arxiv.org/abs/2608.00485)
...
### [95] [The methodology of Constructing the Large-Scale Dataset for Detecting Presuicidal and Anti-Suicidal Signals in Social Media Texts in Russian](https://arxiv.org/abs/2608.00497)
...
### [96] [The Learning Objective Governs Perceptual Narrowing: A Cross-Lingual, Layer-Wise, Ten-Seed Study of Self-Supervised Speech Encoders](https://arxiv.org/abs/2608.00507)
*Sejin Yoo*
...
### [97] [Rethinking and formalising the state across languages: a unified computational learning theory account](https://arxiv.org/abs/2608.00523)
*Mohamed El Idrissi*
...
### [98] [S$^4$R: Selective Sampling, Subspaces, and Sparse Reconstruction for Compressed Long-Context KV Caching](https://arxiv.org/abs/2608.00528)
...
### [99] [Native Multilingual Chain-of-Thought Reasoning in Low-Resource Southeast Asian Languages](https://arxiv.org/abs/2608.00533)
...
### [100] [DE-NER : Zero-shot Named Entity Recognition via Dialogue Elicitation of Large Language Models](https://arxiv.org/abs/2608.00538)
...
### [101] [Loanword or Switch? The Annotation Boundary, Not the Model, Drives Kazakh-Russian Code-Switching Identification](https://arxiv.org/abs/2608.00581)
*Bogdan Savelyev*
...
### [102] [Writing-System-Level Tokenizer Adaptation for Byte-Level BPE](https://arxiv.org/abs/2608.00582)
*Bohdan Didenko*
...
### [103] [Verification Without Sufficiency: Per-Chunk Filtering Fails on Multi-Hop RAG, and Decomposition Repairs It](https://arxiv.org/abs/2608.00585)
*Randhir Kumar*
...
### [104] [A Heuristic Perspective on Debiasing Language Models](https://arxiv.org/abs/2608.00622)
...
### [105] [TreeProbe : A Tibetan Medicine Benchmark for Cultural Bias in LLMs](https://arxiv.org/abs/2608.00640)
...
### [106] [Select-And-Extract: A Lightweight Plugin for Retrieval-Augmented Generation](https://arxiv.org/abs/2608.00658)
...
### [107] [OpenART: Scaling Agent Red Teaming via Open-Ended Environment Evolution](https://arxiv.org/abs/2608.00677)
...
### [108] [AttnLink: Turning Attention into Schema Links for Text-to-SQL](https://arxiv.org/abs/2608.00693)
...
### [109] [Exploiting Intrinsic Duality for Multi-Hop Question Generation](https://arxiv.org/abs/2608.00712)
...
### [110] [Observatorio Lazaro: A self-populating database of anglicism usage in the Spanish press](https://arxiv.org/abs/2608.00713)
...
### [111] [RAGOCR: Optical Compression of Retrieval-Augmented Text via Visual Representation](https://arxiv.org/abs/2608.00765)
...
### [112] [Distill Where You Fail: Recovering Learning Signals of Negative RL-Groups from Adaptive Teacher Guidance](https://arxiv.org/abs/2608.00782)
...
### [113] [OoO-Spec: Out-of-Order Semantic Speculation for Fast Tool Calling](https://arxiv.org/abs/2608.00814)
...
### [114] [Exemplars in Disguise: Pure Exemplar Models Mimic Abstraction-First Learning](https://arxiv.org/abs/2608.00821)
...
### [115] [Pruned BPE: Post-training Visibility Pruning and Token Reallocation for Byte Pair Encoding](https://arxiv.org/abs/2608.00837)
*Kenny Shao*
...
### [116] [Practical Online KV Cache Compaction for LLM Agents: An Empirical Study](https://arxiv.org/abs/2608.00902)
...
### [117] [FinHardBench: Can LLMs Generate Latency-Aware Hardware for Financial Computing?](https://arxiv.org/abs/2608.00909)
...
### [118] [Gaokerena: A Small Persian Medical Language Model Family](https://arxiv.org/abs/2608.00932)
...
### [119] [Mind the Gap: Zero-Query Jailbreaks via Filter-Generator Discrepancy in Text-to-Image Systems](https://arxiv.org/abs/2608.00973)
...
### [120] [Unsupervised Multidomain Approaches to Named Entity Recognition with Small Datasets](https://arxiv.org/abs/2608.00984)
...
### [121] [MedUPS: Towards Diagnostic Assistance in Uncommon Medical Cases with Large Language Models](https://arxiv.org/abs/2608.01012)
...
### [122] [Cloud-ScPO: Hidden-State Geometry for Semi-Supervised Preference Optimization in LLM Reasoning](https://arxiv.org/abs/2608.01014)
...
### [123] [Why LLMs Give In: Conversational Factors and Reasoning Behind Medical Sycophancy](https://arxiv.org/abs/2608.01017)
...
### [124] [Opt.Gear Technical Report](https://arxiv.org/abs/2608.01034)
...
### [125] [DeBERTa-Sentinel: Toward Transparent and Trustworthy Detection of AI-Generated Text](https://arxiv.org/abs/2608.01046)
...
### [126] [Attend to Your Own Thoughts: Breaking the Barrier for Post-Training Quantization of Reasoning LLMs through the Lens of 1.58-Bit Quantization](https://arxiv.org/abs/2608.01078)
...
### [127] [Morphology Aware Reversible Semantic Tokenization and Hierarchical Word Composition for Tamil Language Models](https://arxiv.org/abs/2608.01153)
*Anand Murugan*
...
### [128] [On the Complexity of Computing Outputs of a Metric Turing Machine](https://arxiv.org/abs/2608.00283)
*Yaroslav Ivanashev*
...
### [132] [Alphabet-Preserving Lifting for the Log-Rank Conjecture](https://arxiv.org/abs/2608.01812)
*Zhao Song*
...
Abstract: For a Boolean communication matrix $M$, let $D(M)$ denote its deterministic communication complexity and let $r(M):={\mathrm{rank}}_{\mathbb{R}}(M)$. The log-rank conjecture asks whether $D(M)$ is polynomial in $\log r(M)$. The best known general upper bound, due to Sudakov and Tomon'25, is $D(M)=O(\sqrt{r(M)})$.
...
### [133] [The Complete Extended Euclidean Scheme Is Not in Piecewise Arithmetic $\mathrm{AC}^0$](https://arxiv.org/abs/2608.01987)
*Amiel Ferman*
...
### [134] [Optimal Unambiguous DNFs and Alon-Saks-Seymour](https://arxiv.org/abs/2608.02533)
*Chirag Pabbaraju*
...
### [135] [An Argmax Principle for Sum-of-Squares Relaxations on the Sphere](https://arxiv.org/abs/2608.02594)
...
### [136] [Uncertainty-Aware Simulation-Based Inference for Operations Research with Large Language Models](https://arxiv.org/abs/2608.00019)
...
### [137] [Learning Compositional Meta-Routing for Agentic Workflows: An Executable Benchmark](https://arxiv.org/abs/2608.00106)
...
### [138] [MetaRoute-Bench: Evaluating Meta-Decision Policies for Agentic Workflow Routing](https://arxiv.org/abs/2608.00107)
*Natan Vidra,Alina Kapanova,Arun Kanhai,Spurthi Setty*
...
### [139] [Progressive$^2$: A Teacher-Student Progressive Co-Evolving Knowledge Distillation Method for Substantial Model Compression](https://arxiv.org/abs/2608.00129)
...
### [140] [Rethinking Pretraining for Specialized Design Data: Evidence from the JONES-19 Cultural Design Dataset](https://arxiv.org/abs/2608.00135)
...
### [141] [Leak It: A Probabilistic Approach to Training-Data Extraction from Black-Box Language Models](https://arxiv.org/abs/2608.00144)
*Victor Maricato*
...
### [142] [Response Magnitude as a Dominant Signal for Held-Out CRISPRi Perturbation Effect Prediction](https://arxiv.org/abs/2608.00152)
...
### [143] [Inference-Time Policy Alignment for Fair Reinforcement Learning](https://arxiv.org/abs/2608.00175)
...
### [144] [AutoCause: A Python framework that automates expert decisions in environmental time-series causal discovery](https://arxiv.org/abs/2608.00198)
...
### [145] [A Physics-Chemistry-Informed Neural Network (PCINN) for Real-Time Spatial-ALD Coverage Prediction and Reliable Kinetics Inversion](https://arxiv.org/abs/2608.00212)
...
### [146] [Verifier-Induced Support Reshaping in On-Policy Optimization](https://arxiv.org/abs/2608.00220)
...
### [147] [Similarity-Aware Machine Unlearning](https://arxiv.org/abs/2608.00246)
...
### [148] [Agentic Bayesian Optimization through Surrogate-Augmented Autoresearch](https://arxiv.org/abs/2608.00316)
...
### [149] [Stabilized Best-of-$K$ Training for Neural Combinatorial Optimization](https://arxiv.org/abs/2608.00296)
...
### [150] [Learning the Pareto Frontier of Predictive Models under Distribution Shift](https://arxiv.org/abs/2608.00632)
...
### [151] [Abstention as an Action Can Kill Both the Reward Gradient and the KL Anchor: Collapse Law and Repair for Error-Penalized Reinforcement Learning](https://arxiv.org/abs/2608.00301)
...
### [152] [Characterizing Bias in Post-Bandit Inference under Index Algorithms](https://arxiv.org/abs/2608.01069)
...
### [153] [Neural operator learning for collision-aware trajectory planning of spacecraft swarms](https://arxiv.org/abs/2608.00320)
...
### [154] [Stochastic Sequential Search in Very-High-Dimensional Feature Selection](https://arxiv.org/abs/2608.01502)
...
### [155] [Ensemble of Unsupervised Deep Learning for Clustering Imbalanced Tabular Data](https://arxiv.org/abs/2608.00346)
...
### [157] [Modeling Unknown Nonlocal PDE Systems via Flow Map Learning](https://arxiv.org/abs/2608.00400)
...
### [158] [DSETA: A Dual-Stage Continual Learning Framework for Travel Time Prediction in Dynamic Traffic Environments](https://arxiv.org/abs/2608.00402)
...
### [159] [Pseudorandom Streams within Diffusion Models Act as Learnable Inputs That Affect Generation Quality](https://arxiv.org/abs/2608.02575)
...
### [160] [Unleashing the Potential of Large Language Models: A Blueprint for Real-Time, Enterprise-Ready Deployments](https://arxiv.org/abs/2608.00419)
...
### [161] [HP-JEPA: Hierarchical Partitioning for Multi-Resolution Graph Joint-Embedding Predictive Learning](https://arxiv.org/abs/2608.00491)
...
### [162] [Online Algorithms via Minimax and Posterior Matching](https://arxiv.org/abs/2608.01616)
...
### [163] [Hierarchical Solomonoff Induction: An Unbounded Machine Learning Model](https://arxiv.org/abs/2608.01005)
*Nathan Young*
...
### [164] [Agentic Graph Token Reasoning](https://arxiv.org/abs/2608.00542)
*Zhuoyi Peng,Yi Yang*
...
### [165] [The Fourth Quadrant: A Stylized View of Benign Misfitting](https://arxiv.org/abs/2608.01032)
...
### [166] [Crushing the Evidence: A Dual-Penalty Evasion Framework for Fooling White-Box Explainable AI Auditors](https://arxiv.org/abs/2608.00566)
...
### [168] [Fairness Auditing: Lower Bounds on Company Manipulation](https://arxiv.org/abs/2608.00568)
...
### [169] [CoSynFlow: Conformal Symplectic Neural Flows for Cross-System Prediction of Dissipative Hamiltonian Dynamics](https://arxiv.org/abs/2608.00571)
...
### [170] [From field-scale to large-scale spectral libraries: Tabular foundation models in soil spectroscopy](https://arxiv.org/abs/2608.00608)
...
### [171] [RHEA: Reliability-Harmonized Reconstruction and Assignment for Robust Multimodal-Attributed Graph Clustering](https://arxiv.org/abs/2608.00621)
...
### [172] [Towards Effective Federated Multimodal Graph Learning via Navigating Multifaceted Heterogeneity](https://arxiv.org/abs/2608.00623)
...
### [173] [Relative Parameter Importance in Task-Agnostic Replay-Free Continual Learning](https://arxiv.org/abs/2608.00630)
...
### [174] [Mitigating Backdoors via Decoy Shortcuts and Knowledge Decoupling](https://arxiv.org/abs/2608.00732)
...
### [175] [An Embedded RISC-V Evaluation of Kolmogorov--Arnold Networks in Hard-Constrained Recurrent Physics-Informed Models](https://arxiv.org/abs/2608.00737)
...
### [176] [Generic Vision and Cross-Attention for Reaction Yield Prediction](https://arxiv.org/abs/2608.00776)
*Qiwei Han,Chi Zhou*
...
### [177] [Paris as a 15-Minute City: An Explainable AI Perspective](https://arxiv.org/abs/2608.00815)
...
### [178] [AdvPlan-Bench: Adversarial Evaluation of Structured Plan-Generation Agents](https://arxiv.org/abs/2608.00832)
...
### [179] [Deep Learning CNN and Recurrence Analysis for Alpha Gamma EEG Biomarkers in Fragile X Syndrome](https://arxiv.org/abs/2608.00835)
...
### [180] [Nonlinear Laplacians Improve Signed-Directed Graph Learning](https://arxiv.org/abs/2608.00836)
...
### [181] [Adaptive Quantum Physics-Informed Neural Networks for Differential Equations with Applications to Fluid Dynamics](https://arxiv.org/abs/2608.00850)
...
### [182] [HyperODE: Zero-Shot Surrogate for Simulation and Inference of Dynamical Systems](https://arxiv.org/abs/2608.00852)
*Ajitesh Srivastava*
...
### [183] [SparseKAN: Compressing Kolmogorov--Arnold Networks Across Basis Functions, Neurons, and Bits](https://arxiv.org/abs/2608.00859)
...
### [184] [Kilobyte Models: Neural Networks as a Seed and a Quantized Latent](https://arxiv.org/abs/2608.00860)
...
### [185] [GeoArbiter: Verifiability-Guided Grounding for Remote-Sensing Multimodal LLMs](https://arxiv.org/abs/2608.00877)
*Xuechen Li*
...
### [186] [AOSpec: Action and Observation Co-Speculation for Low-Latency Agent Serving](https://arxiv.org/abs/2608.00881)
...
### [187] [UpliftBench: Revealing Outcome-Regime and Objective Mismatch in Uplift Evaluation](https://arxiv.org/abs/2608.00915)
*Binshuang Li*
...
### [188] [Subtype Robustness Is Not Just Accuracy: Calibration Under Unseen Subtype Shift](https://arxiv.org/abs/2608.00928)
...
### [189] [xMICD: Explainable Representation of Multiple ICD Codes](https://arxiv.org/abs/2608.00935)
...
### [190] [Data-Driven Pinball-Loss Selection for Vertically Distributed Elastic-Net SVMs](https://arxiv.org/abs/2608.00949)
...
### [191] [Interpretable machine learning for predicting splitting strength of asphalt concrete: insights from SHAP analysis](https://arxiv.org/abs/2608.00956)
...
### [192] [One-Sided Quantile Coupling for Flow Matching](https://arxiv.org/abs/2608.00978)
...
### [193] [Beyond Gene Reconstruction: Learning Cell Representations through Complementary Transcriptomic Views](https://arxiv.org/abs/2608.00985)
...
### [194] [Who Belongs in the Eval Set? A Capability-Taxonomy-Driven Pipeline for Curating Regression Eval Sets in Agent-Extensibility Platforms](https://arxiv.org/abs/2608.01004)
...
### [195] [Fused Bayesian Flow Networks for Dual-Target Molecular Design](https://arxiv.org/abs/2608.01007)
...
### [196] [Caliber: Cross-Architecture Extraction-Cost Control for Score-Returning APIs](https://arxiv.org/abs/2608.01023)
...
### [197] [Logit-Origin Centering for Singleton Test-Time Adaptation](https://arxiv.org/abs/2608.01074)
...
### [198] [Breaking Diversity Collapse in Spiking Pseudo-Ensembles for Efficient OOD Detection in Remote Sensing](https://arxiv.org/abs/2608.01090)
...
### [199] [Factorized AdaBoost.MH Achieves the Same Convergence Rate as AdaBoost.MH](https://arxiv.org/abs/2608.01091)
*Xin Zou,Jingyuan Xu*
...
### [200] [FL-OA: A Byzantine-Robust Federated Learning Framework with Outsourced Auditing for Intelligent Devices](https://arxiv.org/abs/2608.01095)
...
### [201] [When Do Surrogate Updates Improve Decisions? A Local Theory of Trajectory-Wise Transfer](https://arxiv.org/abs/2608.01130)
*Yuyang Shen*
...
### [202] [A reproducible and extensible framework for benchmarking competing risks survival models](https://arxiv.org/abs/2608.00271)
...
### [203] [Causal Inference with Unstructured Treatments](https://arxiv.org/abs/2608.00657)
...
### [204] [Round-Trip Consistency: Bidirectional Diffusion Models Can Predict Their Own Rollout Errors](https://arxiv.org/abs/2608.00675)
*Alexander Scheinker*
...
### [205] [Model-Agnostic FDR Control via Group Gaussian Mirror and Permutation SHAP](https://arxiv.org/abs/2608.00989)
...
### [206] [How fine a change can moments see? A scale law for detecting distribution shift, with a kernel calibration rule](https://arxiv.org/abs/2608.01268)
*Adel Kaleche*
...
### [207] [Dominant Arm Identification with Mixing and Recycling Observed Samples](https://arxiv.org/abs/2608.01545)
...
### [208] [Finite-Probe Total-Variation Certificates for Finite-Basis Drifting Models](https://arxiv.org/abs/2608.01547)
...
### [209] [The Label Defines the Timescale: Trait-State Limits of Temporal-Aggregate Learning](https://arxiv.org/abs/2608.01587)
*Xizhe Zhang*
...
### [210] [Detecting Nonproperness of Likelihood Equations](https://arxiv.org/abs/2608.01976)
...
### [211] [Private Generative Bootstrap via Blocking](https://arxiv.org/abs/2608.02480)
...
### [212] [Computational and Statistical Guarantees of the \textit{c}-Rectified flow](https://arxiv.org/abs/2608.02487)
...
### [213] [Interaction Is Not Necessary for Order-Optimal 1-Bit Mean Estimation](https://arxiv.org/abs/2608.02538)
...
### [214] [GNN-RSMA: An Interference Management Framework for a Large-Scale HAPS Network](https://arxiv.org/abs/2608.00380)
...
### [215] [Channel-Agnostic Semantic Compression for Bandwidth-Limited Visual Communication](https://arxiv.org/abs/2608.00394)
...
### [216] [Frequency Coding over Noisy Sampling](https://arxiv.org/abs/2608.00539)
...
### [217] [An Information Theoretic Treatment of Yager's Probability Distribution Negation](https://arxiv.org/abs/2608.00594)
...
### [218] [Symplectic Barnes-Wall GKP Codes: Deterministic $O(N \log^2 N)$ Decoding and Logarithmic Rate Scaling](https://arxiv.org/abs/2608.00601)
*Shanxiang Lyu*
...
### [219] [New Results Towards the Characterization of Service Rate Region of Reed-Muller Codes](https://arxiv.org/abs/2608.00810)
...
### [220] [Partially-Observable Transmission Control for UAV-Enabled Federated Learning in IoT Networks](https://arxiv.org/abs/2608.00855)
...
### [221] [Goal-Oriented Logic-based Semantic Communication for Neuro-Symbolic Reasoning with Applications onto Autonomous Driving](https://arxiv.org/abs/2608.00878)
...
### [222] [Age Dispersion and Higher-Order AoI in Status Update Systems](https://arxiv.org/abs/2608.01006)
...
### [223] [Spatial Prefix Caching for Wireless Edge LLM Inference: A Stochastic-Geometry and Queueing Framework](https://arxiv.org/abs/2608.01126)
...
### [224] [Perfect codes as exact minimizers of quadratic discrepancy in q-ary Hamming spaces](https://arxiv.org/abs/2608.01134)
...
### [225] [Schur--Plucker Geometry of the MDS Locus for Principal-Ideal Codes](https://arxiv.org/abs/2608.01146)
...
### [226] [Bridging Differential Privacy and Random Triangles](https://arxiv.org/abs/2608.01412)
*Tianxi Ji*
...
### [227] [Capacity of Additive-Noise Sticky Channels](https://arxiv.org/abs/2608.01433)
...
### [228] [Linear network codes for vector-linear network function computation over three-layer networks](https://arxiv.org/abs/2608.01566)
*Min Xu,Gennian Ge*
...
### [229] [Movable Subarray-Aided ISAC in Hybrid Near-Far Field Channels](https://arxiv.org/abs/2608.01854)
...
### [230] [CARNet: Channel-Adaptive Receiver Network for Robust NextG Communications](https://arxiv.org/abs/2608.02172)
...
### [231] [Open-Loop Transmission with Discrete Blocklengths: Characterization of AoI-Optimal Schedules](https://arxiv.org/abs/2608.02231)
...
### [232] [A Spatio-Temporal Model for Information Freshness in Massive Random Access](https://arxiv.org/abs/2608.02286)
...
### [233] [Minimum Distances of Binary Goppa Codes and Constructions with Prescribed Alternating Automorphism Groups](https://arxiv.org/abs/2608.02436)
...
### [234] [PhaseLift for Coded Diffraction Patterns: Optimal Sampling Rate](https://arxiv.org/abs/2608.02450)
*Gao Huang,Song Li*
...
### [235] [Fast Trainable Multilinear Bases for Image Compression](https://arxiv.org/abs/2608.00053)
...
### [236] [FDIR: Harmonizing Fidelity and Human-Machine Preference in Lossy Compression Image Restoration](https://arxiv.org/abs/2608.00111)
...
### [237] [RPL-UIE: Reliable Prior Learning for Underwater Image Enhancement](https://arxiv.org/abs/2608.00137)
...
### [238] [Automatic LV Localization and Short-Axis Plane Estimation from Arbitrary CMR Slice](https://arxiv.org/abs/2608.00145)
...
### [239] [MedSAM2-Anatomy: Training-Free Inference-Time Optimization for Musculoskeletal Segmentation](https://arxiv.org/abs/2608.00195)
...
### [240] [Learning to See Locally and Align Clinically with Pathology Semantics for Radiology Report Generation](https://arxiv.org/abs/2608.00279)
*Xuan Cuong Ngo*
...
### [241] [Fused electrical impedance tomography using an electromagnetically tracked handheld probe for oral cancer margin assessment: reconstruction methods and phantom validation](https://arxiv.org/abs/2608.00312)
...
### [242] [Streamable Neural Video Compression: A Mixed Precision Approach for Cross-Platform Deployment](https://arxiv.org/abs/2608.00483)
...
### [243] [Spinal-Multiple-Myeloma-SEG: A Dual-Energy CT Dataset Extended with Trabecular Bone Segmentation of Lumbar Vertebrae](https://arxiv.org/abs/2608.01482)
...
### [244] [Hadamard-Domain Model Quantization for Learned Image Coding](https://arxiv.org/abs/2608.01653)
...
### [245] [Mapping melliferous tree species in Kenya via one-class classification with hyperspectral unsupervised domain adaptation](https://arxiv.org/abs/2608.02045)
...
### [246] [Protocol generalisation for brain tissue microstructure estimation via hypernetwork-controlled geometric deep learning](https://arxiv.org/abs/2608.02053)
...
### [247] [An Accessible Solution for Deformable Image Registration Compared with Learning-Based Approaches](https://arxiv.org/abs/2608.02248)
...
### [248] [A Subsampling Theorem for Constraint Satisfaction Problems with Large Arity](https://arxiv.org/abs/2608.00203)
...
### [249] [Robust Polynomial Freiman-Ruzsa from Corrupted Set Observations via a Sharp Persistent-Subset BSG Compiler](https://arxiv.org/abs/2608.00451)
*Cheng Peng*
...
### [250] [An Analysis of Brent's Insertion Method for Hash Tables](https://arxiv.org/abs/2608.00762)
*William Kuszmaul*
...
### [251] [Sublinear Time Eigenvector Approximation via Column Sampling](https://arxiv.org/abs/2608.00840)
...
### [252] [A Consistency-Robustness Framework for Robust Optimization: Integrating Predictions into Robust Scheduling](https://arxiv.org/abs/2608.00848)
...
### [253] [Testing Full Quartet Consistency: Adaptive Reconstruction, Random Verification, and Constant-Query Testability](https://arxiv.org/abs/2608.00987)
*Chuang-Chieh Lin*
...
### [254] [Computational Thresholds for Balanced and Fixed-Slice Independent Sets in Bipartite Graphs](https://arxiv.org/abs/2608.02503)
...
### [255] [Active Regression for Single-Index Models with Unknown Link Functions](https://arxiv.org/abs/2608.01287)
...
### [256] [Dense Language Generation Made Simple: Deterministic, Randomized, and Multi-Order Algorithms](https://arxiv.org/abs/2608.01320)
...
### [257] [Context Compaction Theory](https://arxiv.org/abs/2608.01326)
...
### [258] [MEM-finding with run-length compressed strings](https://arxiv.org/abs/2608.01387)
...
### [259] [Approximating the Trace Distance Between Product Quantum States](https://arxiv.org/abs/2608.01841)
...
### [260] [Minimal-to-Maximal Conversion Search Is Not Output-Polynomial](https://arxiv.org/abs/2608.02159)
...
### [261] [Randomized Algorithms for Learning Partitions with Near Optimal Query Complexity in Constant Rounds](https://arxiv.org/abs/2608.02176)
...
### [262] [Reconfiguration of Temporal Networks under Reachability Constraints](https://arxiv.org/abs/2608.02227)
...
### [263] [Noisy k-means++ is Not too Noisy](https://arxiv.org/abs/2608.02318)
*Poojan Shah*
...
### [264] [Recovering Planted Colorings in Sublinear Time](https://arxiv.org/abs/2608.02338)
...
### [265] [Solving the Shortest Vector Problem in time $2^{0.6039n}$ Time via Mid-point Hessian](https://arxiv.org/abs/2608.02478)
*Minki Hhan*
...
### [266] [Approximating two-terminal network reliability](https://arxiv.org/abs/2608.02523)
...
### [267] [Pairwise-Independent Dithering for Single-Stage Hadamard Quantization](https://arxiv.org/abs/2608.02564)
...
### [268] [The Condition-Number Barrier in Sparse Least Squares](https://arxiv.org/abs/2608.02588)
*Honghao Lin,Vahab Mirrokni,David P. Woodruff*
...
### [269] [Revisiting Classic Thought Experiments to Measure Consciousness for Artificial Intelligence Safety](https://arxiv.org/abs/2608.00001)
*Peter David Fagan*
...
### [270] [AutoFOAM: The Self-Refining Autonomous OpenFOAM Agent](https://arxiv.org/abs/2608.00003)
...
### [271] [Enhancing LLMs with Context-Specific Knowledge for Mitigating Misinformation in SMEs: A RAG-based Modeling and Analysis](https://arxiv.org/abs/2608.00006)
...
### [272] [Energy Efficiency of Locally Deployed LLMs: A Preliminary Quantitative GPU Power Benchmark on Consumer Hardware](https://arxiv.org/abs/2608.00008)
...
### [273] [CoT-Core: Accelerating LLM Evaluation via CoT-Aware Coreset Selection](https://arxiv.org/abs/2608.00014)
...
### [274] [Optimization and Constraint Modeling using LLMs with a Retrieval Augmented Generation Process](https://arxiv.org/abs/2608.00015)
...
### [275] [Memory Reward Inflation in Self-Improving LLM Agents](https://arxiv.org/abs/2608.00017)
...
### [276] [Request-Level Energy Attribution for Batched LLM Serving](https://arxiv.org/abs/2608.00026)
...
### [277] [Motif-Mamba: network motif improved mamba for long-range sequence modeling](https://arxiv.org/abs/2608.00027)
...
### [278] [Nova: An End-to-End MLIR Compiler for Deep Learning](https://arxiv.org/abs/2608.00029)
...
### [279] [SIRIN: A Unified Toolkit for Detecting Contextual Hallucinations in Retrieval-Augmented and Memory-Grounded LLM Systems](https://arxiv.org/abs/2608.00033)
...
### [280] [Linguistic Context Recodes Visual Representations in Vision-Language Models](https://arxiv.org/abs/2608.00035)
...
### [281] [RAG-TESTER: Automated End-to-End Testing of Retrieval-Augmented Large Language Models](https://arxiv.org/abs/2608.00054)
...
### [282] [H+ Embedding: Harmonizing Global and Token-Level Retrieval with Context-Dependent Phrases](https://arxiv.org/abs/2608.00065)
...
### [283] [Evolutionary Curriculum Learning Improves Biological Sequence Modeling](https://arxiv.org/abs/2608.00697)
...
### [284] [Agentic Coding in the Wild: Characterizing GitHub Copilot Traces at Production Scale](https://arxiv.org/abs/2608.00101)
...
### [285] [Can LLM Agents Price Competitively? A Dynamic Multi-Attribute Auction Benchmark for Agentic Commerce](https://arxiv.org/abs/2608.00102)
...
### [286] [Shared Organizational Memory for Enterprise Coding Agents: System Design and Deployment Snapshot](https://arxiv.org/abs/2608.00122)
...
### [287] [AgentStream: How Well Do Self-Evolving LLM Agents Perform Under Streaming Tasks?](https://arxiv.org/abs/2608.00155)
...
### [288] [TRACE-TS: Attribution-Grounded and Traceable Sensor-Language Reasoning for Human Activity Understanding](https://arxiv.org/abs/2608.00200)
...
### [289] [Personalizing Large Language Model Agents with Small Policy Models](https://arxiv.org/abs/2608.00215)
...
### [290] [More Debate, Same Evidence: Structural Limits of Homogeneous Multi-Agent Groundedness](https://arxiv.org/abs/2608.00243)
*Yuelyu Ji*
...
### [291] [Geometric Self-Supervised Pre-training for Neural Combinatorial Optimization](https://arxiv.org/abs/2608.00270)
...
### [292] [RF-HOI: Recognize Human-Object Interaction with Radio Frequency Signals](https://arxiv.org/abs/2608.00289)
...
### [293] [WM-Cov: Test Adequacy for Interactive World-Model-Style Autonomous Driving Simulation](https://arxiv.org/abs/2608.00298)
...
### [294] [CrystalMem: Elastic Memory for Self-Evolving LLM Agents via Knowledge Crystallization](https://arxiv.org/abs/2608.00303)
...
### [295] [Trust and Its Betrayal under Three Representational Strategies](https://arxiv.org/abs/2608.00321)
...
### [296] [Learning to Coordinate Symbolic Tools: LLM Agents for Verified Sum-of-Squares Certificates](https://arxiv.org/abs/2608.00326)
...
### [297] [RMSWeb: Reflection, Failure-Mode Mining, and Salvage-DS for Web Agent Reinforcement Learning](https://arxiv.org/abs/2608.00335)
...
### [298] [Bayesian and Motivated Reasoning in AI Agents](https://arxiv.org/abs/2608.00339)
*Eddie Yang*
...
### [299] [Gene Ontology-Guided Hierarchical Spatial Gene Expression Prediction from Histopathology Images](https://arxiv.org/abs/2608.00405)
...
### [300] [Where did the ambiguity go? Examining how multimodal models interpret polysemous words](https://arxiv.org/abs/2608.00410)
...
### [301] [SymboUQ: Symbolic Uncertainty Quantification for Spatial Reasoning in LLMs](https://arxiv.org/abs/2608.00417)
...
### [302] [Mask-Based Priors Are More Persistent than Query-Key Initializations](https://arxiv.org/abs/2608.00418)
...
### [303] [TrAC: Trace-Conditioned Answer Consistency for Efficient Uncertainty Quantification in LLMs](https://arxiv.org/abs/2608.00422)
*Dahai Yu,Lin Jiang,Rongchao Xu,Guang Wang*
...
### [304] [Diagnose Before You Compress: Prediction-Independent Bottleneck Witness Refinement for LLM Serving Traces](https://arxiv.org/abs/2608.00423)
...
### [305] [Ekova: A Personality-Support Agent for Self-Discovery Dialogue](https://arxiv.org/abs/2608.00478)
*Yuyan Chen*
...
### [306] [F-WANDA: Fisher-Reweighted Post-Training Pruning for Sustainable Deployment of Large Language Models](https://arxiv.org/abs/2608.00481)
*Himanshu Mishra*
...
### [307] [The Bayesian Reflex: A Predictive Coding Engine for Artificial Intelligence](https://arxiv.org/abs/2608.00492)
...
### [308] [TaPR: Test-Aware Policy Refinement for Feedback-Conditioned Code Generation](https://arxiv.org/abs/2608.00494)
...
### [309] [BayesSeg: A Bayesian Optimization Framework for State Segmentation of Electricity Consumption Time Series](https://arxiv.org/abs/2608.00513)
...
### [310] [CURE: Local Uncertainty Repair for Block-Parallel Speculative Decoding](https://arxiv.org/abs/2608.00531)
*Aofan Liu,Jingxiang Meng,Fangxin Liu,Yongbiao Chen*
...
### [311] [Through the LENS: Local Geometric Decomposition of Vision-Language Model Representations](https://arxiv.org/abs/2608.00561)
...
### [312] [Why Does the Future Branch? Identifiable Closure Tests for Stochastic Physical World Models](https://arxiv.org/abs/2608.00591)
*Yibin Dong*
...
### [313] [Escaping Confidence Trap: Evolutionary Decoding for Mathematical Reasoning in Diffusion LLMs](https://arxiv.org/abs/2608.00605)
...
### [314] [Slides2MindMap: Reconstructing Cognitively Efficient Knowledge Hierarchies from Lecture Slides](https://arxiv.org/abs/2608.00610)
...
### [315] [DASH: Decoupled Adaptive Surrogate - Acquisition Harness for Automated Bayesian Optimization](https://arxiv.org/abs/2608.00641)
...
### [316] [HetGPS: Scalable Graph Multi-Agent Reinforcement Learning with Physics-Anchored Adaptive Safety for EV Charging](https://arxiv.org/abs/2608.00679)
...
### [317] [Multi-Dimensional Assessment for AI Cognition (MAAC): A Theoretical Framework for Process-Oriented Cognitive Evaluation of Text-Based AI Systems](https://arxiv.org/abs/2608.00680)
...
### [318] [When Does LLM Orchestration Pay Off? A Controlled Evaluation of Accuracy, Cost, and Task Difficulty](https://arxiv.org/abs/2608.00685)
...
### [319] [DGA$_2$D: Directed Graph-Guided Automated Algorithm Design with Large Language Models](https://arxiv.org/abs/2608.00700)
...
### [320] [Tracing the Cascade: A Topology-Aware Evaluation Framework for Scientific Agent Hallucinations](https://arxiv.org/abs/2608.00711)
...
### [321] [AI-Based Thesis Assessment: An Empirical Study of Human Evaluation Priorities and Their Impact on Automated Assessment](https://arxiv.org/abs/2608.00717)
...
### [322] [Behavioral Grammar: Detecting Adaptive Malware via Tiny Language Model Priors and Second-Order Temporal Analysis](https://arxiv.org/abs/2608.00745)
*Zihan Luo*
...
### [323] [FinDeepIndicator: Benchmarking Deep Research Agents in End-to-End Financial Indicator Construction](https://arxiv.org/abs/2608.00764)
...
### [324] [Measurement Without Validity: The Compounding Reliability Problem in Agentic AI Evaluation](https://arxiv.org/abs/2608.00794)
*William Caban*
...
### [325] [AgentSLABench: Evaluating and Benchmarking Agentic Systems Under Resource Constraints](https://arxiv.org/abs/2608.00805)
...
### [326] [Large language models improve physician accuracy but lead to false reliance](https://arxiv.org/abs/2608.00817)
...
### [327] [The Scaling Paradox in Human-AI Collaboration](https://arxiv.org/abs/2608.00818)
...
### [328] [Isotropy Cliffs: The Geometric Signature of Decision-Making in Large Language Models](https://arxiv.org/abs/2608.00828)
...
### [329] [Similarity Weighted Aggregation with Global Differential Privacy for Federated Brain Lesion Segmentation](https://arxiv.org/abs/2608.00872)

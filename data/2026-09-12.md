...
### [9] [Your Model Already Knows Don't Teach It, Learn to Ask It: Soft Prompting for Few-Shot Adaptation of Vision-Language Models](https://arxiv.org/abs/2609.11310)
...
### [11] [UBone3D: Physics-Rectified Conditional Flow Matching for Anatomical 3D Shape Completion from Ultrasound](https://arxiv.org/abs/2609.11506)
...
### [135] [A Mathematical Theory of Pragmatic Information](https://arxiv.org/abs/2609.10986)
*Kai Niu,Ping Zhang*

Main category: cs.IT

TL;DR: 本文提出了一种统一的实用信息论框架，通过“等终态映射”将通信、控制与决策相结合，建立了语法、语义和实用信息的三层 hierarchy，并推导了实用熵、信道容量及编码定理，将香农理论从符号保真度扩展至目标导向行动的有效性，为下一代智能系统提供了数学基础。


<details>
  <summary>Details</summary>
Motivation: 现有香农信息论主要关注符号层面的传输保真度，缺乏对信息在指导目标导向行动（如控制与决策）中有效性的量化。为了填补通信、控制与决策之间的理论鸿沟，需要一种能够统一处理任务导向型通信和网络化控制的数学语言，以解决资源受限智能系统的根本行为能力极限问题。

Method: 提出“等终态映射”（isoteleia mapping）形式化等终态性，构建语法、语义、实用信息的三层抽象架构；定义实用熵、上下行互信息、实用信道容量及率失真函数；证明推广香农经典结果的三个编码定理；引入信息实用价值（VoI）与成本（CoI）作为对偶量，建立拉格朗日对偶框架进行跨层优化；利用贝尔曼方程处理动态序列决策，并推导连续消息下的高斯闭式解。

Result: 建立了实用效率界限 $\mathcal{E}_p(λ)$，量化了资源受限智能系统可提取的最大净效用，确立了从符号级容量到目标导向行动容量的泛化；导出了连续消息场景下的闭式高斯表达式；形成了涵盖静态与动态设置的完整数学框架，实现了从关注符号保真度向关注信息引导行动有效性的范式转变。

Conclusion: 该框架为任务导向通信、网络化控制、自主系统及具身AI提供了严谨的理论基础，通过统一数学语言将信息论扩展至行为层面，确立了智能系统在资源约束下的根本行为能力极限，标志着信息论从传输中心向行动中心的演进。
...
### [136] [Data Protection in Function-Correcting Symbol-Pair Codes: Redundancy Bounds and Protection Profiles](https://arxiv.org/abs/2609.10989)
...
### [137] [Physics of Information Geometry - Part II: Small-Step Active Inference on the Probability Simplex](https://arxiv.org/abs/2609.11187)
...
### [138] [Occupancy-Domain Over-the-Air Computation](https://arxiv.org/abs/2609.11289)
...
### [139] [Geometric Analysis of Doppler-Based Navigation with Low Earth Orbit Satellites](https://arxiv.org/abs/2609.11296)
...
### [140] [Maximal Kolmogorov Complexity in a Hamming Ball](https://arxiv.org/abs/2609.11362)
...
### [141] [A Tight Second-Order Converse Bound for Variable-Length Feedback Codes](https://arxiv.org/abs/2609.11368)
*Recep Can Yavas*
...
### [142] [Entropy concavity for log-concave random variables: an asymmetric counterexample](https://arxiv.org/abs/2609.11418)
*Congyi Luo*
...
### [143] [Fundamentals of Energy-Efficient Hardware Configurations for Wireless Links with Sleep Modes](https://arxiv.org/abs/2609.11474)
...
### [144] [Linear Codes over $\mathbb{F}_{q}+u\mathbb{F}_{q}$ associated with Simplicial Complexes, Their Gray Images, and Subfield Codes](https://arxiv.org/abs/2609.11783)
...
### [145] [Second-Order Expansion of Privacy Amplification Under f-Divergence Criteria](https://arxiv.org/abs/2609.11794)
...
### [146] [The Computational Complexity of Holant Problems on 4-regular Graphs from the Stable Subgroup Sequence of $SL(2,\mathbb{C})$](https://arxiv.org/abs/2609.11175)
*Yuan Huang,Zhiguo Fu*

Main category: cs.CC

TL;DR: 本文针对全复杂值签名的Holant问题分类中“全偶数元数”这一核心障碍，建立了包含复杂值4元签名的Holant问题的计算复杂性二分法，引入了舒尔定理、SL(2,C)有限子群分类及稳定子群序列等新证明策略。


<details>
  <summary>Details</summary>
Motivation: 过去二十年间，Holant问题的计算复杂性二分法已取得系列进展，但复杂值签名的完整分类仍未解决，主要瓶颈在于所有签名均为偶数元数（even arity）的情形，缺乏针对该情形的关键基例（base case）分类。

Method: 引入并整合了三项新技巧至证明过程中：舒尔定理（Schur's theorem）、复特殊线性群$\mathrm{SL}(2,\mathbb{C})$的有限子群分类，以及稳定子群序列（stable subgroup sequences）。

Result: 成功建立了具有复杂值4元签名的Holant问题的计算复杂性二分法，解决了全偶数元数情形下的一个关键基例问题。

Conclusion: 该研究不仅填补了Holant问题完整分类中的关键空白，其引入的新证明技术（如群论工具的应用）本身也具有独立的学术价值，为后续解决更广泛的复杂值签名分类问题奠定了基础。
...
### [147] [Max Independent Set Remains NP-hard when Excluding a Planar Induced Minor](https://arxiv.org/abs/2609.11285)
...
### [148] [Topology inside NC$^1$](https://arxiv.org/abs/2609.11822)
...
TL;DR: 本文提出 M3-Former，一种利用大语言模型增强多模态信息的船舶轨迹预测框架，以解决长期预测中的误差累积与语义利用不足问题。


<details>
  <summary>Details</summary>
Motivation: 针对船舶轨迹预测中行为多模态性、语义信息利用受限及长期误差累积导致的轨迹漂移挑战。

Method: 构建统一多模态表示空间，通过 LLM 编码静态语义并与动态特征对齐；采用双粒度混合专家（MoE）架构分别建模全局导航趋势与局部机动行为；设计转向加权交叉熵损失优化稀疏转向样本预测。

Result: 在丹麦 AIS 数据集上，该方法在 1-4 小时预测 horizon 上均优于 SOTA 基线；4 小时预测任务中 ADE 和 FDE 较最强基线分别降低 4.4% 和 5.1%。

Conclusion: 语义融合有效抑制长期轨迹漂移，双粒度 MoE 增强了复杂场景鲁棒性，建立了语义引导的分层预测范式。
...
### [156] [Convex Optimization with Nested Evolving Feasible Sets (CONES) under Time-Varying Loss Functions](https://arxiv.org/abs/2609.11207)
*Rahul Vaze*
...
### [157] [The Truth Was Never Gone: Perfect Aliasing in Compliant-Context Truth Probes](https://arxiv.org/abs/2609.10739)
*Dylan Jayabahu*
...
### [158] [Flow Duality and Source Geometry for Categorical Generation](https://arxiv.org/abs/2609.10863)
*Etrit Haxholli*
...
### [160] [Learning Orthogonal Multi-Index Models Beyond Small Initialization: Incremental Learning, Competitive Dynamics and Symmetry](https://arxiv.org/abs/2609.10879)
...
### [161] [A Bellman Optimality Equation for Plasticity](https://arxiv.org/abs/2609.10776)
...
### [162] [Relatively Smart II: Tractable or Semi-Supervised Instance-Optimal Learning](https://arxiv.org/abs/2609.10886)
...
### [164] [AUC Maximization from Biased Positive-unlabeled Data with Confidence](https://arxiv.org/abs/2609.10928)
...
### [166] [Phases in a class of associative memories via hidden neurons](https://arxiv.org/abs/2609.10976)
...
### [168] [Importance Weighting for Unlabeled-unlabeled Learning under Distribution Shift](https://arxiv.org/abs/2609.10994)
*Atsutoshi Kumagai,Tomoharu Iwata,Hiroshi Takahashi,Taishi Nishiyama,Kazuki Adachi,Yasuhiro Fujiwara*
...
### [174] [Generalized Score Matching for Parameter Estimation on Convex Domains](https://arxiv.org/abs/2609.11521)
...
### [175] [RDDMPI: Residual Denoising Diffusion Model for Probabilistic Multivariate Time Series Imputation](https://arxiv.org/abs/2609.11648)
...
### [176] [Story Imprinting: AI Assistants Absorb Traits from Human Characters They Resemble](https://arxiv.org/abs/2609.10883)
...
### [177] [General Quantification of Covariate and Concept Shifts](https://arxiv.org/abs/2609.11918)
...
### [189] [Bidirectional Multimodal Fusion of Sky Images and Time-Series for Solar Forecasting with Large Language Models](https://arxiv.org/abs/2609.11135)
...
### [190] [LILA: Calibration-Free Structured Pruning of Large Language Models via Latent Spectral Geometry](https://arxiv.org/abs/2609.11163)
...
### [191] [When does a spectral prior help graph learning? Connectivity-loss estimation under road-network disruptions](https://arxiv.org/abs/2609.11166)
*Van-Truong Le*
...
### [192] [Semi-Tensor Product-Based Multi-Term Randomized T-SVD and Its Visual Applications](https://arxiv.org/abs/2609.11168)
...
### [193] [REVA: Reusable Evidence View Aggregation for Context-Efficient RAG Serving](https://arxiv.org/abs/2609.11209)
...
### [194] [Legible Failures: Detecting and Repairing In-Context Binding Errors](https://arxiv.org/abs/2609.11216)
...
### [195] [Polyhedral Geometry of Time-to-First-Spike Neural Networks](https://arxiv.org/abs/2609.11227)
...
### [196] [Solving Few-Shot Multiobjective Multitask Optimization via Iterative Sequential Transfer](https://arxiv.org/abs/2609.11228)
...
### [197] [MUtE: A Dual Framework for Concept Erasure and Counterfactual Interventions](https://arxiv.org/abs/2609.11253)
*Antoine Saillenfest*
...
### [198] [A Dynamic Fusion Large Language Model for Traffic Flow Prediction](https://arxiv.org/abs/2609.11314)
*Xue Qiu,Jianli Xiao*
...
### [199] [Estimating Inconsistency Response Surfaces under Uncertainty in Cyber-Physical System Development](https://arxiv.org/abs/2609.11331)
...
### [200] [Reification as a Transferable Vocabulary: Zero-Shot Link Prediction with Vanilla GNNs](https://arxiv.org/abs/2609.11347)
*Camille Pradel*
...
### [201] [Local Robustness Quantification for Naive Bayes Classifiers and Generative Forests: a General Approach](https://arxiv.org/abs/2609.11366)
...
### [202] [Prevalence Determines Precision:Silent Contamination in Detector-Defined Datasets](https://arxiv.org/abs/2609.11449)
...
### [203] [Combining Synthetic and Real Data for Low-Resource Historical OCR: A Manchu Case Study](https://arxiv.org/abs/2609.11495)
...
### [204] [DeFiFlowBench: Benchmarking and Improving Safe Executability in Natural-Language DeFi Workflow Synthesis](https://arxiv.org/abs/2609.11504)
...
### [205] [Particle GFlowNets: Rethinking Generative Marginalization Models](https://arxiv.org/abs/2609.11538)
...
### [206] [A Dataset and Model for Imputing Water Surface Elevation on a Large and Extremely Sparse Spatiotemporal Graph](https://arxiv.org/abs/2609.11580)
...
### [207] [LoaDiff: Conditional Generation of Electricity Consumption Time Series for Energy Analytics](https://arxiv.org/abs/2609.11639)
...
### [208] [Musec: MomentUm SpEctral Clipping for Stable Muon-type Training](https://arxiv.org/abs/2609.11655)
...
### [209] [Learnware and AI Model Management System](https://arxiv.org/abs/2609.11656)
*Zhi-Hua Zhou*
...
### [210] [Why Does Post-Training Quantization Work?](https://arxiv.org/abs/2609.11716)
...
### [211] [Predicting Privacy Leakage from Weight Spectral Density](https://arxiv.org/abs/2609.11780)
...
### [212] [Dynamic language model representations for multi-objective reaction optimisation](https://arxiv.org/abs/2609.11790)
...
### [213] [Thinking with Looped Flows](https://arxiv.org/abs/2609.11801)
...
### [214] [Model-Aware Schedules Improve Generation via Fiberwise Optimal Transport](https://arxiv.org/abs/2609.11842)
...
### [215] [AdamX: Cosine similarity meets gradient descent](https://arxiv.org/abs/2609.11867)
...
### [216] [The Last AI Built by Humans: Toward Genuine Recursive Self-Improvement](https://arxiv.org/abs/2609.11873)
...
### [217] [CoRA-NAS: Coarse Ranking and Anchor-Residual Refinement for Neural Architecture Search](https://arxiv.org/abs/2609.11884)
...
### [218] [CausalArena: Benchmarking Causal Discovery in the Foundation Model Era](https://arxiv.org/abs/2609.11897)
...
### [219] [TART: A Modular Tool for Technique-Aware Audio-to-Tablature Guitar Transcription](https://arxiv.org/abs/2609.11904)
...
### [220] [From Protocols to Evidence: Bounded Claims for AI in Service of the Common Good](https://arxiv.org/abs/2609.11910)
...
### [221] [Data Scarcity and Model Sparsity: Mixtures-of-Experts Overfit More to Repeated Data](https://arxiv.org/abs/2609.11917)
...
### [222] [A Deadline-Driven Algorithm for Polyamorous Scheduling](https://arxiv.org/abs/2609.10641)
*Arjun Maneesh Agarwal*

Main category: cs.DS

TL;DR: 本文针对多角恋调度问题（Polyamorous Scheduling Problem），提出了一种近似比为 $4 G^*$ 的新算法，将此前 $3 + \sqrt{5} \approx 5.236$ 的近似比界限进行了显著优化。


<details>
  <summary>Details</summary>
Motivation: 该问题源于复杂社会群体中安排成对会面日程的实际需求，旨在最小化同一边（即两人关系）连续出现之间的最大加权等待时间。作为竹园修剪问题（Bamboo Garden Trimming）的推广，该问题具有 NP 难性，需要更高效的近似算法来解决。

Method: 受竹园修剪问题中最优的“截止日期驱动启发式”（Deadline-Driven Heuristic）算法启发，设计了一种新的近似算法。该算法通过构建图的周期性匹配调度，优化了加权等待时间的上界。

Result: 成功将多角恋调度问题的近似比从已知的 $3 + \sqrt{5} \approx 5.236$ 降低至 $4 G^*$（其中 $G^*$ 为图的最大度或相关结构参数，具体依上下文定义，此处指代更优的常数或参数化界限），实现了理论界限的突破。

Conclusion: 该研究不仅提升了多角恋调度问题的算法性能，还证明了从竹园修剪问题中借鉴启发式策略的有效性，为处理更复杂的周期性调度问题提供了新的理论工具。
...
### [223] [Lower Bounds for Private Graph Optimization Problems using Reconstruction Attacks](https://arxiv.org/abs/2609.10877)
...
### [224] [Quasi-Monte Carlo Beyond Hardy-Krause II: $(1 + \varepsilon)n$ Samples Suffice](https://arxiv.org/abs/2609.10921)
...
### [225] [A deterministic $(1+\varepsilon)^n$ approximation for the permanent of a nonnegative matrix](https://arxiv.org/abs/2609.11049)
...
### [226] [Single-Exponential Algorithms and a Polynomial Kernel for Strong Connectivity Augmentation](https://arxiv.org/abs/2609.11160)
...
### [227] [A Reusable Framework for Robust Approximation Algorithms in the Interval Uncertainty Model](https://arxiv.org/abs/2609.11621)
...
### [228] [Weighted Empirical Risk Minimization for Machine Learning under Long-Range Dependence: Exact Pathwise Rates and Learning-Error Geometry](https://arxiv.org/abs/2609.10767)
*Elina Moldavskaya*

Main category: stat.ML

TL;DR: 本文建立了针对长程依赖数据训练的平滑参数模型的精确几乎必然学习理论，推导了学习参数的几乎必然Bahadur表示、精确上极限律及轨迹聚类集，并发现多项式学习指数由记忆参数和混沌秩决定且对加权方式不变。


<details>
  <summary>Details</summary>
Motivation: 旨在解决在长程依赖（长记忆）数据下，通过正则加权经验风险最小化训练平滑参数模型时的收敛性与路径行为问题，填补现有理论在几乎必然收敛及精细路径几何描述方面的空白。

Method: 基于固定有限窗口的平稳高斯序列生成训练观测值，采用正则变化样本权重；利用Wiener混沌展开分析总体最小值处的损失梯度，在长记忆内部机制下，将有限滞后得分约化为单个加权Hermite混沌，进而推导几乎必然Bahadur表示和迭代对数尺度的极限律。

Result: 获得了学习参数的几乎必然Bahadur表示和精确上极限律；对于混沌秩$m\ge2$，确定了完整学习轨迹的函数聚类集；发现多项式学习指数仅取决于记忆参数和混沌秩，对允许幂加权具有不变性，但尖锐路径常数和聚类几何依赖于权重；在秩为1的情况下，证明了全局优化器均为正数。

Conclusion: 该理论揭示了长程依赖数据下模型学习的精细渐近行为，明确了学习速率与路径几何的决定因素，并通过时间序列预测和分类实例验证了理论结果的有效性。
...
### [229] [A Hilbert-Valued Functional Decomposition Framework for Explaining Time-Dependent Outputs](https://arxiv.org/abs/2609.11295)
*Sophie Hanna Langbein,Niklas Koenen,Marvin N. Wright,Julia Herbinger*

Main category: stat.ML

TL;DR: 本文提出了一种统一框架，用于解释具有时间依赖性的函数型或多变量模型输出，解决了现有方法仅独立解释各输出点而忽略组件间依赖关系的局限。


<details>
  <summary>Details</summary>
Motivation: 现有的基于特征的解释方法主要针对标量输出设计，而在需求预测等应用中，输出往往是函数型或多变量的（如随时间变化的轨迹）。现有方法通常独立解释每个输出位置，忽略了输出组件之间的依赖关系。

Method: 将函数分解推广到希尔伯特值预测函数，并扩展现有的基于特征的解释框架。引入基于核的输出表示，以实现多层级时间粒度（特定时间、时间解析、时间聚合）的感知解释，并将现有方法作为特例纳入统一视角。

Result: 在合成数据和真实世界数据（包括日内金融市场波动率预测和能源需求预测）上验证了该框架的有效性。

Conclusion: 该框架成功解决了时间依赖输出的解释问题，提供了能够捕捉时间依赖性的多层级解释视角，并统一了现有的解释方法。
...
### [230] [Risk-Averse Decision Making with Multi-Level Reliability Guarantees](https://arxiv.org/abs/2609.11524)
*Amirmohammad Farzaneh,Osvaldo Simeone*

Main category: stat.ML

TL;DR: 本文研究了在系统状态不确定下最大化不同目标中断水平的加权平均性能证书的问题，提出了基于嵌套预测集的优化方法，并通过无线传输系统实验验证了多级证书的成本与可靠性权衡。


<details>
  <summary>Details</summary>
Motivation: 工程应用（如无线广播）需要在不同目标中断水平下提供性能保证，但现有研究多集中于单级风险规避决策，缺乏在不确定性下同时优化多级性能证书的有效方法。

Method: 将问题转化为嵌套预测集上的优化问题，联系共形预测理论，并推导出一种对偶公式以解耦不同输入值的优化过程。

Result: 数值实验表明，使用单一共享策略强制执行多级证书会产生成本，并揭示了多个可靠性水平之间的帕累托权衡关系。

Conclusion: 该方法扩展了单级风险规避决策的先验工作，为不确定性下的多级性能证书优化提供了理论框架和实用工具。
...
### [231] [A distribution-free certification framework for trustworthy crash-severity prediction](https://arxiv.org/abs/2609.11592)
*Amir Rafe,Subasish Das*

Main category: stat.ML

TL;DR: 本文提出了一种通用的“认证层”框架，为交通事故严重程度预测模型提供分布无关的有限样本保证，解决了现有模型在序数标签噪声、跨域部署及真实严重程度不可观测等挑战下的可靠性缺失问题。


<details>
  <summary>Details</summary>
Motivation: 现有的事故严重程度模型虽用于筛选和调度，但缺乏对单次预测意义的有限样本陈述。由于事故数据具有序数性（KABCO）、现场评估标签存在结构化误差（与医疗严重程度仅约50%一致），且部署环境跨越了训练未见的辖区和年份，导致现成的统计保证失效。

Method: 开发了一种可包裹任意现有模型的认证层，利用数据结构提供分布无关保证：包括连续序数集（如“B或更严重”）的预测集、任意预声明分区的类有效性、通过声明的报告带将覆盖率转移至未观测的真实严重程度、部署偏移下的单侧认证以及严重程度加权风险控制。该框架还结合了可归因的松弛预算，并通过记录链接数据识别误报通道以计算非平凡的下界。

Result: 在跨越四十年的520万条德克萨斯州记录及七个基础模型上的实验表明，该层能附加一致的效度保证。特别是在弱势道路使用者群体上，它认证了一个模型无关的集合宽度下界，任何基础模型都无法超越，从而将可识别的误差部分与分布无关下不可识别的剩余部分分离开来。

Conclusion: 该框架不仅提供了严格的理论保证和开源实现（含定理级测试），还界定了认证的极限：认证集的信息量受限于真实分布的泛函，该下界在无分布假设下无法被基础模型规避或下界化，但在已知误报机制时可计算。
...
### [232] [Identifiability of Nonnegative Tensor Decompositions via Positive Scattering](https://arxiv.org/abs/2609.11606)
...
### [233] [Generalization Analysis of Distributed Kernel-based Robust Gradient Descent Algorithms](https://arxiv.org/abs/2609.11712)
...
### [234] [Near-Optimal Reinforcement Learning with Multi-Step Transition Lookahead](https://arxiv.org/abs/2609.11807)
...
### [235] [Evaluating Time-Series Foundation Models and Multimodal Dietary Context for CGM Forecasting](https://arxiv.org/abs/2609.11872)
...
### [236] [Generative Marketing Mix Modeling: A Causal Inference Framework Linking GEO and GEM to Business Impact](https://arxiv.org/abs/2609.11915)
...
### [237] [Probabilistic Focal Search: Accelerating Bounded-Suboptimal Search via Lower-Bound Advancement](https://arxiv.org/abs/2609.10584)
...
### [238] [Automating Quadratic Unconstrained Binary Optimization (QUBO) Formulation Generation from Natural Language](https://arxiv.org/abs/2609.10629)
...
### [239] [A Multi-Stage Rule-Chaining Framework for Compositional and Interpretable Cognitive Reasoning](https://arxiv.org/abs/2609.10654)
*Deblina Kar*
...
### [240] [Understanding LoRA Rank Trade-offs in Diffusion Model Fine-Tuning](https://arxiv.org/abs/2609.10656)
...
### [241] [Quantifying the Memorization-to-Generalization Transition: Scaling Laws and Phase Structure in Grokking](https://arxiv.org/abs/2609.10657)
*Anish Kataria*
...
### [242] [An Open Recipe for IMO Gold: Training Nemotron for Olympiad Mathematics](https://arxiv.org/abs/2609.10712)
...
### [243] [Task- and Session-Level Model Routing: A Common-Interface Hybrid Evaluation of Four Open-Source Routers Across Four Benchmarks](https://arxiv.org/abs/2608.14641)
...
### [244] [Finishing the Task Is Not Enough: Evaluating Agent Resilience and Considerate Participation under Accumulating Challenge](https://arxiv.org/abs/2609.10724)
...
### [245] [Towards a Deterministic Math Solver for Clinical Language Models](https://arxiv.org/abs/2609.10728)
...
### [246] [Studying Without a Syllabus: Task-Agnostic Environment Preprocessing](https://arxiv.org/abs/2609.10824)
...
### [247] [When Validation Stops Learning: Auditing Update Admission for Continual Embodied Agents](https://arxiv.org/abs/2609.10873)
...
### [248] [Decoupling Readiness from Release for Tail-Aware Scheduling of Agentic LLM Workflows](https://arxiv.org/abs/2609.10964)
...
### [249] [When Does Text Inform? Benchmarking Information-Theoretic Metrics for Multimodal Time-Series Forecasting](https://arxiv.org/abs/2609.11282)
...
### [250] [Demystifying the Privacy-Utility Trade-off in LLM Interactions](https://arxiv.org/abs/2609.10992)
...
### [251] [Defining AI Agents: A Compendium of Criteria, Metrics, and Benchmarks](https://arxiv.org/abs/2609.11018)
...
### [252] [The Agent Incident Registry: Toward Preventing Repeated AI Agent Failures](https://arxiv.org/abs/2609.11030)
...
### [253] [Grounding Agent Memory: Environment-Probing Curation for Enterprise Agents](https://arxiv.org/abs/2609.11060)
...
### [254] [Fork Where the Model Changes Its Mind: Belief-Shift Branching for Tree-Structured Reinforcement Learning](https://arxiv.org/abs/2609.11061)
...
### [255] [MOSAIC: Query-Aware Exploration Policy Adaptation for GraphRAG](https://arxiv.org/abs/2609.11065)
...
### [256] [Benchmark Radar: A Living Database and Search Engine for AI Benchmarks and Evaluation](https://arxiv.org/abs/2609.11115)
...
### [257] [KuaiRP Series Role-playing Models Technical Report](https://arxiv.org/abs/2609.11127)
...
### [258] [Same Day, Same Story; One Day Ahead, a Different Signal: The Dual Validity of Financial Sentiment](https://arxiv.org/abs/2609.11144)
...
### [259] [The Oligarch Barely Steers Model Collapse in Multi-Model Ecosystems](https://arxiv.org/abs/2609.11146)
*Yangze Liu,Zhongyi Han*
...
### [260] [Autonomous Chemical Mechanistic Discovery through Agentic Reasoning and Validation](https://arxiv.org/abs/2609.11147)
...
### [261] [DRG-MAPPO: Hierarchical Dynamic Role-Graph Multi-Agent Reinforcement Learning for Cooperative Air Combat](https://arxiv.org/abs/2609.11155)
...
### [262] [Breaking Predictions Is Not Enough: Specified-Foil Counterfactuals for Temporal Graphs](https://arxiv.org/abs/2609.11170)
...
### [263] [Debate-to-Skill: Capability-Bound Process Supervision for Industrial Query-to-Agent Annotation](https://arxiv.org/abs/2609.11176)
...
### [264] [SemVerBench: Benchmarking LLM Comprehension of Version-Constraint Resolution Semantics](https://arxiv.org/abs/2609.11180)
...
### [265] [Can LLMs Follow Medical Expert Logic? A Benchmark for Hierarchical Logical Consistency in Risk-of-Bias Assessment](https://arxiv.org/abs/2609.11185)
...
### [266] [Agentic Share-of-Search: A Multi-Agent AI System for Competitive Decision-Making in LLM-Mediated E-Commerce](https://arxiv.org/abs/2609.11190)
...
### [267] [An AI-Powered Culturally Aware Chatbot for Stress Detection and Wellness Support among Pakistani University Students Using NLP and Machine Learning](https://arxiv.org/abs/2609.11199)
...
### [268] [CryptoL: Towards Scale Dominance and Physics Constraints Mitigation in Financial Multivariate Time Series Forecasting](https://arxiv.org/abs/2609.11206)
...
### [269] [A Voice-Interactive Multi-Agent System for Smart Operating Rooms: Architecture Design and Key Technologies](https://arxiv.org/abs/2609.11231)
*Tianxiang Zhou*
...
### [270] [NovGauge: A Fine-Grained Benchmark for Diagnosing LLMs' Capability in Paper Novelty Assessment](https://arxiv.org/abs/2609.11234)
...
### [271] [Sci-MMR: Benchmarking Multi-Step Evidence-Grounded Scientific Reasoning in Multimodal Agents](https://arxiv.org/abs/2609.11243)
...
### [272] [AI-Powered Flare Combustion Efficiency Estimation](https://arxiv.org/abs/2609.11262)
...
### [273] [Predicting Train Delays in Finland Using Machine Learning and Weather Data](https://arxiv.org/abs/2609.11277)
...
### [274] [Bio-inspired Learning and Decision-Making with Probabilistic In-Memory Computing Hardware: Part 1](https://arxiv.org/abs/2609.11281)
...
### [275] [Generating a Consistent Enterprise: Synthesis and Reference-Free Evaluation of Multi-System Business Data](https://arxiv.org/abs/2609.11286)
...
### [276] [Off-Target Effects of Response-Style Alignment in a Korean 27B Language Model](https://arxiv.org/abs/2609.11291)
*Hyojung Han*
...
### [277] [Memory Compression for High-Fanout Agent Sandboxes](https://arxiv.org/abs/2609.11294)
...
### [278] [Routing by Reasoning Need: Trajectory-Aware Decoding Control for Diffusion Vision-Language Models](https://arxiv.org/abs/2609.11315)
...
### [279] [Mr.LHDR: A Benchmark for Multimodal Real-World Long-Horizon Deep Research Agents](https://arxiv.org/abs/2609.11318)
...
### [280] [Magenta: Closing the Loop Between Mathematical Reasoning and Lean Verification](https://arxiv.org/abs/2609.11319)
...
### [281] [AI Exposure and AI Resilience: A Two-Dimensional Assessment Framework for Software and Software-Based Business Model](https://arxiv.org/abs/2609.11321)
...
### [282] [Exploring Diffusion Transformers for Cross-Modal Augmentation in Multimodal Brain State Decoding](https://arxiv.org/abs/2609.11341)
...
### [283] [Portable Semantics, Private Dialects: Reuse and Negative Transfer in Latent Communication Between Language-Model Cells](https://arxiv.org/abs/2609.11365)
*Narcis Marincat*
...
### [284] [RAMamba-Net: A Reliability-Aware and Mamba-Based Multimodal Fusion Network for Auditory Attention Detection](https://arxiv.org/abs/2609.11372)
...
### [285] [Beyond Confidence: Stability-Aware Test-Time Adaptation for LLM Reasoning](https://arxiv.org/abs/2609.11393)
...
### [286] [From Queries to Narratives: Cultural Heritage Data Stories for Knowledge Graph Exploration and Quality Assessment](https://arxiv.org/abs/2609.11403)
...
### [287] [LLMs as Post-hoc Auditors of Physiological Plausibility in Symbolic Regression: A Clinician-Evaluated Case Study](https://arxiv.org/abs/2609.11431)
...
### [288] [Calibration-Aware Uncertainty Cascades for Efficient Heterogeneous Model Collaboration](https://arxiv.org/abs/2609.11446)
...
### [289] [RouteRepair: Instance-Level Failure Diagnosis and Targeted Repair in LLM-Based Automated Heuristic Design for Routing Optimization](https://arxiv.org/abs/2609.11452)
...
### [290] [Flexible and Interpretable Accent Distance Measurements](https://arxiv.org/abs/2609.11458)
...
### [291] [The Convention Gap: Towards Measuring Implicit Communication in Cooperative AI Evaluation](https://arxiv.org/abs/2609.11489)
...
### [292] [Published Unlearning Numbers Move Per Checkpoint, and Not Because the Removed Data Survives: An Audit of 263 Released Batch-Normalized Checkpoints](https://arxiv.org/abs/2609.11490)
...
### [293] [From Document Silos to Process Intelligence: A Multi-Layer Knowledge Graph for CMC Process Development](https://arxiv.org/abs/2609.11493)
...
### [294] [ActMap: Single-Pass Uncertainty Quantification from Generation-Time Activation Maps](https://arxiv.org/abs/2609.11498)
...
### [295] [Extending SMT Solving with Non-Ground Clause Learning](https://arxiv.org/abs/2609.11509)
...
### [296] [Lightweight LiDAR-Based Cone Detection Framework Using Random Forest for Formula Student Driverless](https://arxiv.org/abs/2609.11527)
...
### [297] [Prompt Revision as a Source of Cultural Bias in Text-to-Image Systems](https://arxiv.org/abs/2609.11532)
...
### [298] [Characterizing Job Power Elasticity for Power-Flexible AI Training](https://arxiv.org/abs/2609.11542)
...
### [299] [Enabling Knowledge Graph Understanding at Scale with the EXplore Your Graphs ENgine (EXYGEN)](https://arxiv.org/abs/2609.11569)
...
### [300] [Making Alternative Data Work: Context-Augmented LLMs for Financial Forecasting](https://arxiv.org/abs/2609.11607)
...
### [301] [Distributed Optimization of Modular Production Systems using Model-based Reinforcement Learning with Inverse Models](https://arxiv.org/abs/2609.11615)
...
### [302] [MAPLE: Memory-Augmented Planning with Language and Evolution](https://arxiv.org/abs/2609.11636)
...
### [303] [Autonomy, Social Norms, and Alignment: Towards a Developmental Framework for Autonomous Artificial Agents](https://arxiv.org/abs/2609.11660)
...
### [304] [Geospatial AI, Dataverse Metadata, and the Study of Place-Based Government](https://arxiv.org/abs/2609.11674)
...
### [305] [COBRA-Skills: Contextual Bandit-Guided Evolution for Agent Skill Optimization](https://arxiv.org/abs/2609.11682)
...
### [306] [When Agents Disagree: Bayesian Backward Reasoning as a Label-Free Anchor for Multi-Agent Collective Decision-Making](https://arxiv.org/abs/2609.11709)
...
### [307] [SIRF: A Spec-Internalized Risk Foundation Model for Industrial Content Risk Control](https://arxiv.org/abs/2609.11752)
...
### [308] [A Unified Per-Token Gating Family for On-Policy Distillation: FKL/RKL Mixing with Multi-Channel and Bias Coefficients](https://arxiv.org/abs/2609.11768)
*Suwan Wu,Yumeng Lin,Pengcheng Yuan,Xiaolong Jiang*
...
### [309] [From Parameters to Answers: How LLMs Retrieve and Use Their Internal Knowledge](https://arxiv.org/abs/2609.11859)
...
### [310] [Explainability Assistant: A Conversational XAI Interface for Interpreting Energy Consumption Models](https://arxiv.org/abs/2609.11860)
...
### [311] [On the Regularization Landscape for the Linear Recommendation Models](https://arxiv.org/abs/2609.11876)
...
### [312] [MindTopo: Can Foundation Models Reason in Topological Space?](https://arxiv.org/abs/2609.11900)
...
### [313] [Artificial Id: Drive and Persistent Alignment in Agentic AI](https://arxiv.org/abs/2609.11911)
...
### [314] [Can Edge-Deployable Vision-Language Models Identify Species?](https://arxiv.org/abs/2609.11916)
...
### [315] [Physics-Informed Sequential Reconstruction of Scanning Probe Microscopy Images with Calibrated Uncertainty](https://arxiv.org/abs/2609.10638)
...
### [316] [XPos3R: Cross-Modal Transformer for Intraoperative 2D/3D Registration](https://arxiv.org/abs/2609.10733)
...
### [317] [Scale-Aware 3D Deep Learning for Robust Brain Metastasis Detection in Multimodal MRI](https://arxiv.org/abs/2609.10825)
...
### [318] [Annotating anatomy and pathology in the National Lung Screening Trial computed tomography images](https://arxiv.org/abs/2609.10858)
...
### [319] [Seamless Whole Slide Label-Free Virtual Staining](https://arxiv.org/abs/2609.10914)
...
### [320] [Exponential Pixelating Integral transform with dual fractal features for enhanced chest X-ray abnormality detection](https://arxiv.org/abs/2609.10988)
